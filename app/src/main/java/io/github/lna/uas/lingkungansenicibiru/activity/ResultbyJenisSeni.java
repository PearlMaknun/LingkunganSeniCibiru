...
public class ResultbyJenisSeni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultby_jenis_seni);
    ...
    public void getData() {
        ...
        Call<LingkunganSeniResponse> call = apiService.getLingSenibyJenisSeni(nama, API_KEY);
